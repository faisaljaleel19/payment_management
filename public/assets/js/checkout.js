function getPaymentPage(url, paymentMethod, amount, currency, email, order, csrf) {
    ...
    $.ajax({
        ...
        data: {paymentMethod: paymentMethod, amt:amount, currency:currency, email:email, order:order},
