                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card mt-7" id="print_area">
                            ...
                            <div class="card-body">
                                @if(!$fail)
                                <h3 class="font-weight-black text-dark display-6 text-center">Success</h3>
                                <hr>
                                ...
                                <div class="mt-2 text-center">
                                    <button class="btn btn-secondary" id="printMe">Print &nbsp; <i class="fa fa-print"></i></button>
                                </div>
                                @elseif(($message === 'Transaction Declined'))
                                    <h3 class="font-weight-black text-dark display-6 text-center">Transaction Declined</h3>
                                @else
